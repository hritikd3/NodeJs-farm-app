...
const tempOverview = fs.readFileSync(`${__dirname}/base/overview.html`, "utf-8"); //__dirname tells you the absolute path of the directory containing the currently executing file.
